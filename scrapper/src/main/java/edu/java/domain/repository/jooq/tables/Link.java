...
package edu.java.domain.repository.jooq.tables;

import edu.java.domain.repository.jooq.DefaultSchema;
import edu.java.domain.repository.jooq.Keys;
...
public class Link extends TableImpl<LinkRecord> {
    ...
    /**
     * The column <code>LINK.STAR_COUNT</code>.
     */
    public final TableField<LinkRecord, Integer> STAR_COUNT =
        createField(DSL.name("STAR_COUNT"), SQLDataType.INTEGER, this, "");

    /**
     * The column <code>LINK.ANSWER_COUNT</code>.
     */
    public final TableField<LinkRecord, Integer> ANSWER_COUNT =
        createField(DSL.name("ANSWER_COUNT"), SQLDataType.INTEGER, this, "");

    /**
     * The column <code>LINK.UPDATED_DATE</code>.
     */
    public final TableField<LinkRecord, LocalDateTime> UPDATED_DATE =
        createField(DSL.name("UPDATED_DATE"), SQLDataType.LOCALDATETIME(6).nullable(false), this, "");

    /**
     * The column <code>LINK.CHECKED_DATE</code>.
     */
    public final TableField<LinkRecord, LocalDateTime> CHECKED_DATE =
        createField(DSL.name("CHECKED_DATE"), SQLDataType.LOCALDATETIME(6).nullable(false), this, "");
    ...
    public <U> SelectField<U> mapping(
        Class<U> toType,
        Function5<? super String, ? super Integer, ? super Integer, ? super LocalDateTime, ? super LocalDateTime, ? extends U> from
    ) {
